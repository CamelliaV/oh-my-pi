...
import { markUsageRowBlock } from "../overlays/usage-row";
import { theme } from "../theme/theme";

/** Structural view of a persisted session entry. The coding-agent session
 * store satisfies this; the tui must not import that package. */
