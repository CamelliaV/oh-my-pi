...
export const SETTINGS_SCHEMA = {
	...
	"tui.titleSpinner": {
		type: "enum",
		values: ["pie", "braille", "pulse", "dots", "line"] as const,
		default: "pie",
		ui: {
			tab: "appearance",
			group: "Display",
			...
			description:
				"Glyph set for the working-state spinner in the terminal title — nerd-font pie ring, braille sweep, filling moon, single-dot cycle, or ASCII-safe line",
			options: [
				{ value: "pie", label: "Pie Ring", description: "Nerd-font pie sweep  (default)" },
				{ value: "braille", label: "Braille", description: "Classic ⠋⠙⠹ sweep" },
